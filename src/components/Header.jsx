    ...
    items-center justify-center'>
          ...
          <div className='relative'>
            <motion.img whileTap={{ scale: 0.6 }}
              src={user ? user.photoURL : Avatar} alt="user_img"
              className="w-10 min-w-[40px] h-10 min-h-[40px]
   drop-shadow-x cursor-pointer rounded-full"
              onClick={login}
            />
            {
              isMenu && (
                <motion.div
                  ...
                  className='w-40 bg-grey-50 shadow-xl rounded-lg flex flex-col absolute top-12 
            right-0
            '>
                  {user && user.email === "oladeniifeoluwa123@gmail.com" && (
                    <Link to={"/createItem"}>
